namespace Banking.Presentation
{
	partial class ViewCreditors
	{
		...
		private void InitializeComponent()
		{
			...
			this.lend = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			// lend
			// 
			this.lend.HeaderText = "Lend";
			this.lend.Name = "lend";
			this.lend.ReadOnly = true;
			// 
			// endDate
			// 
			...
			// guarantee
			// 
			this.guarantee.HeaderText = "Guarantee";
			...
			this.Name = "ViewCreditors";
			this.Text = "ViewCreditors";
			this.Load += new System.EventHandler(this.ViewCreditors_Load);
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn lend;
